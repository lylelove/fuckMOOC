...
tele = ''  ##手机号
password = ''  ##密码
course = "https://www.icourse163.org/learn/SDCJDX-1449597161" ##课程地址
unit = 12  ##单元数
waitTime = 0.5  ##等待时间
...
driver.get(course)
driver.find_element(By.XPATH, "/html/body/div[4]/div[1]/div/div/div/div/div[6]/div/div/div/a").click()
...
for num in range(1, unit + 1):
    units = "/html/body/div[4]/div[2]/div[4]/div[2]/div/div[1]/div/div[2]/div[" + str(num + 1) + "]/div[2]/div[1]/a"
    time.sleep(waitTime)
